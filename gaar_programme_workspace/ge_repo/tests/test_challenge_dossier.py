...
def test_dossier_preserves_falsification_engine():
    from challenge_dossier import create_dossier
    d = create_dossier(control_id="M3.12", control_title="x", reviewer="r", blind={}, challenges=[],
                       challenger_model="m", knowledge=[], falsification_engine={"schema":"v0.7.falsification-engine.1", "coverage":{"coverage_ratio":1.0}})
    assert d["falsification_engine"]["schema"] == "v0.7.falsification-engine.1"

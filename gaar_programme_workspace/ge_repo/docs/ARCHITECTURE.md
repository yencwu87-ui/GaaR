...
| Reviewer gate | `app.py` Review workspace | Named reviewer accepts or overrides; the AI proposal is stored beside the decision | Yes — the only step that records |

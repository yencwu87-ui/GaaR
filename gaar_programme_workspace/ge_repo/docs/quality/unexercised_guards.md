...
**Scope of the trace.** The tracer covers the twenty-eight modules named in `tools/trace_unreached_guards.py` (kit v20 added
...
Summary: 0 registered; all 12 previously registered guards are reached by exact-message tests (kit v19). Trace scope: twenty-eight modules; of the command-line tools, only the round tool is traced.
